...
<div class="container-fluid">
    ...
    <div class="small text-muted mb-3">
        Ruta del formulario: {{ route('admin.users.store') }}
    </div>
            ...
            <form action="{{ route('admin.users.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select name="registration_type" id="registration_type" class="form-control @error('registration_type') is-invalid @enderror" required>
                        ...
                        <option value="virtual" {{ old('registration_type') === 'virtual' ? 'selected' : '' }}>Virtual</option>
                        <option value="presential" {{ old('registration_type') === 'presential' ? 'selected' : '' }}>Presencial</option>
                        <option value="student" {{ old('registration_type') === 'student' ? 'selected' : '' }}>Estudiante</option>
                    </select>
